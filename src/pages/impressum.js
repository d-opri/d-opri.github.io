...
import SectionElement from "../../components/sections/Container";

const impressum = () => {
  return (
    <SectionElement title="Impressum">
      <Description>
        <p>Angaben gemäß § 5 TMG</p>
        <p>
          <br />
          Daniela Opri <br />
          Greifswalderstraße 157 <br />
          10409 Berlin{" "}
        </p>
        <p>
          {" "}
        ...
        <p>
          <strong>Kontakt:</strong>Telefon: 0157-30912159
          <br />
        </p>
        <p>
          E-Mail:{" "}
          <a href="mailto:dani.opri@protonmail.com">dani.opri@protonmail.com</a>{" "}
        </p>
        <p>
          <br /> <br />
        ...
        <p>
          ...
          durch Sie ermöglicht. Google Adsense verwendet auch sog. `&apos;Web
          Beacons`&apos; (kleine unsichtbare Grafiken) zur Sammlung von
          Informationen. Durch die Verwendung des Web Beacons können einfache
          Aktionen wie der Besucherverkehr auf der Webseite aufgezeichnet und
          ...
          Ihre Nutzung der Website im Hinblick auf die Anzeigen auszuwerten, um
          ...
          (Im MS Internet-Explorer unter `&apos;Extras {
            ">"
          ...
          benannten Zweck einverstanden. <br /> <br />
          Impressum vom <br />
